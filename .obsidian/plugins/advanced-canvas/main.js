...
var CanvasPatcher = class {
  ...
  async applyPatches() {
    ...
    if (canvasLeaf && (0, import_obsidian.requireApiVersion)("1.7.2"))
      await canvasLeaf.loadIfDeferred();
    const canvasView = (_b = canvasLeaf == null ? void 0 : canvasLeaf.view) != null ? _b : await new Promise((resolve) => {
